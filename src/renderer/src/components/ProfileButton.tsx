    ...
    <>
      ...
      <button
        ...
        className="relative w-10 h-10 rounded-full flex items-center justify-center border-2 transition-all duration-200 cursor-pointer shrink-0
          bg-[#0f0f0f] border-[#1e1e1e] hover:border-primary hover:shadow-[0_0_12px_rgba(245,158,11,0.25)]"
      ...
      >
        {profile ? (
          <>
            ...
            <span className="absolute -bottom-0.5 -right-0.5 w-4 h-4 rounded-full bg-black border border-[#1e1e1e] flex items-center justify-center text-[9px] text-primary">
      ...
      {showModal && (
        ...
        >
          <div className="bg-black border border-[#1e1e1e] rounded-[6px] w-full max-w-md p-6 shadow-2xl animate-in fade-in zoom-in-95 duration-200">
            {profile ? (
              /* ── Profile View ── */
              <>
                ...
                <div className="flex flex-col items-center mb-6">
                  <div className="w-20 h-20 rounded-full bg-gradient-to-br from-primary to-primary flex items-center justify-center text-zinc-950 text-2xl font-bold">
                    {getInitials(profile.displayName)}
                  </div>
                  <p className="mt-3 text-zinc-100 text-xl font-semibold flex items-center gap-2">
                    {profile.displayName}
                    <span className="text-primary text-lg">{genderSymbol(profile.gender)}</span>
                  </p>
                </div>

                {/* Info Rows */}
                <div className="space-y-3 mb-6">
                  <div className="flex justify-between items-center bg-[#0f0f0f] rounded-lg px-4 py-3">
                ...
                <button
                  onClick={handleClear}
                  className="w-full px-4 py-2.5 bg-primary/10 border border-primary/20 rounded-lg text-primary text-sm font-medium hover:bg-primary/20 transition-colors cursor-pointer"
                >
                  Clear Profile
                </button>
              </>
              ...
              <>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-[#0f0f0f] border border-[#1e1e1e] rounded-lg px-4 py-2.5 text-zinc-100 placeholder:text-zinc-500 focus:outline-none focus:border-primary/70 transition-colors"
                      autoFocus
                    />
                  </div>
                      ...
                      <button
                        ...
                        className={`flex-1 flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg border text-sm font-medium transition-colors cursor-pointer ${
                          gender === "male"
                            ...
                            : "bg-[#0f0f0f] border-[#1e1e1e] text-zinc-400 hover:border-zinc-600"
                        }`}
                      >
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-[#0f0f0f] border border-[#1e1e1e] rounded-lg px-4 py-2.5 text-zinc-100 focus:outline-none focus:border-primary/70 transition-colors [color-scheme:dark]"
                    />
                  </div>
                ...
                <div className="flex gap-3 mt-6">
                  <button
                    onClick={() => setShowModal(false)}
                    className="flex-1 px-4 py-2.5 bg-[#0f0f0f] border border-[#1e1e1e] rounded-lg text-zinc-300 hover:bg-zinc-700 transition-colors cursor-pointer"
                  >
                    Cancel
                  </button>
                  <button
                    ...
                    className="flex-1 px-4 py-2.5 bg-primary rounded-lg text-zinc-950 font-medium hover:bg-primary disabled:opacity-50 disabled:cursor-not-allowed transition-colors cursor-pointer"
                  >
                    Save Profile
                  </button>
                </div>
